...
**Job To-do List Settings**<br>
  ...
  1. At the desktop site's navigation bar, go to Company Settings > Job Settings > Job To Do List.<br>
     **Open Job To Do List Settings Here:** [https://system.caction.com/settings/commentRequirementSettings](https://system.caction.com/settings/commentRequirementSettings)<br>
...
**Job Status Segmentation**<br>
  ...
  1. At the desktop site's navigation bar, go to Company Settings > Job Settings > Job Status Segmentation.<br>
     **Open Job Status Segmentation Here:** [https://system.caction.com/settings/statusTransaction?page=act](https://system.caction.com/settings/statusTransaction?page=act)<br>
