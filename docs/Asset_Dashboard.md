...
1. At the desktop site navigation bar, go to Business Management > Dashboard > Asset.<br>
   **Open Asset Dashboard Here:** [https://system.caction.com/dashboard/asset](https://system.caction.com/dashboard/asset)<br>
...
<!-- [Link Text](https://support.caction.com/Asset_Dashboard.html) -->
