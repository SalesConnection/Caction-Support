...
## Job Dashboard
   ...
   *Note: This guide can also be applied to Project and Digital Form Dashboard.
   ...
   1. At the desktop site's navigation bar, go to Business Management > Dashboard > Job.<br>
      **Open Job Dashboard Page Here:** [https://system.caction.com/dashboard/task](https://system.caction.com/dashboard/task)<br>
   ...
   3. You can the job status that you want to view.
      ...
      <p align="center">
        <img src="img2/Job_Dashboard_Tutorial_Step_3.png" alt="Job Dashboard Page Tutorial Step 3">
      </p><br>
  ...
  29. Click on the "Default Filter" to select Favourite Filter and set it as default filter.
      ...
      <p align="center">
        <img src="img2/Job_Dashboard_Tutorial_Step_29.png" alt="Job Dashboard Page Tutorial Step 29">
      </p><br>
...
<!-- [Link Text](https://support.caction.com/Job_Dashboard.html) -->
