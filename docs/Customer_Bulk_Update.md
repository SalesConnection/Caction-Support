...
*Note: This guide for Bulk Update is to batch edit existing data in the system. To import new data, please refer to the related articles attached at the bottom of the page. 
  ...
  1. If you want to do bulk update for customer, at the desktop site's navigation bar, go to Import > Customer Bulk Update.<br>
     **Do Customer Bulk Update Here:** [https://support.caction.com/customerbulkimport](https://support.caction.com/customerbulkimport)<br>
     **Do Project Bulk Update Here:** [https://support.caction.com/dealbulkimport](https://support.caction.com/dealbulkimport)<br>
     **Do Product/Services Bulk Update Here:** [https://support.caction.com/productbulkimport](https://support.caction.com/productbulkimport)<br>
     **Do UOM Bulk Update Here:** [https://support.caction.com/uomimport/uomedit](https://support.caction.com/uomimport/uomedit)<br>
