...
4) Set the frequency for the job to repeat. <br>
<p align="center">
         <img src="img2/Repeat_Job_Step_4.png" alt="Repeat Job Guide">
</p><br>

### Scenario 1: By End Date  
#### The job repeats until the specified end date.

5) Click the 'days' and select the <br>
<p align="center">
         <img src="img2/Repeat_Job_Step_5.png" alt="Repeat Job Guide">
         <img src="img2/Repeat_Job_Step_6.png" alt="Repeat Job Guide">
</p><br>

6) Select the date to change it to your preferred one. <br>
<p align="center">
         <img src="img2/Repeat_Job_Step_7.png" alt="Repeat Job Guide">
</p><br>

7) Click the 'Continue' button to proceed with the selected repeat settings. <br>
<p align="center">
...
8) Select and set the number of occurrences after which the job will stop repeating. <br>
<p align="center">
...
10) The recurrent job shows the jobs will be repeated weekly on Tuesday for 2 times.  <br>
<p align="center">
