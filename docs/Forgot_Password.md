...
11. Now, you need to go back to Sales Connection app, and use your new password to login.<br>
...
**Related Articles**<br>
-[How to login form phone number?](https://salesconnection.github.io/Sales-Connection-Support/Login.html#section2)<br>
